    ...
    <Dialog.TriggerContext>
      ...
      <Dialog>
        ...
        <Paragraph style={{ marginBottom: "1rem" }}>
          Denne dialogen blokkerer resten av siden til den lukkes.
        </Paragraph>
  ...
  return (
    <div style={{ display: "grid", gap: "0.75rem", justifyItems: "start" }}>
      ...
      <Dialog ref={dialogRef} modal={false}>
        ...
        <Paragraph style={{ marginBottom: "1rem" }}>
          Denne dialogen lar deg fortsatt samhandle med siden bak.
        </Paragraph>
    ...
    <div style={{ display: "grid", gap: "1rem", justifyItems: "start" }}>
      ...
      <Dialog.TriggerContext>
        ...
        >
          <Dialog.Block>
            <Paragraph>
              Dette er en {modal ? "modal" : "ikke-modal"} dialog med{" "}
