...
export const Default: Story = {
  render: () => (
    <Alert data-color="warning">
      Suggestion er en eksperimentell komponent hos Digdir. Vi viser derfor
      foreløpig ikke egne eksempler her. Se lenken til Digdir for oppdatert
      dokumentasjon og eksempelbruk.
    </Alert>
  ),
};
