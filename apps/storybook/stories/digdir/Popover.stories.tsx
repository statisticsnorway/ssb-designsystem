  ...
  render: () => (
    <>
      <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
        ...
        <Popover.TriggerContext>
          ...
          <Popover data-color="danger">
            <Paragraph>
              Er du sikker på at du vil slette raden? Handlingen kan ikke
              angres.
            </Paragraph>
          </Popover>
        </Popover.TriggerContext>
      ...
      <div style={{ marginTop: "2rem" }}>
        ...
        <Popover.TriggerContext>
          <Paragraph>
            Vi bruker <Popover.Trigger inline>ordforklaring</Popover.Trigger>{" "}
            for å forklare noen ord i teksten.
          </Paragraph>
          ...
          <Popover data-color="neutral">
            <Paragraph>
              ...
              <span>
                Orforklaring er en type popover som brukes til å forklare
                betydningen av et ord eller uttrykk i teksten.
              </span>
            </Paragraph>
          </Popover>
        </Popover.TriggerContext>
