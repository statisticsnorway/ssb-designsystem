    ...
    <div className={classes.components} {...props}>
      <div className={cl(classes.alert)}>
        <Alert data-color="info">
          ...
          <Paragraph>
            Denne siden viser eksempler på noen av komponentene i
            designsystemet, og er ment som en referanse for hvordan de ser ut i
      ...
      <div className={cl(classes.card, classes.calculator)}>
        ...
        {showError && (
          <ErrorSummary>
            ...
            <ErrorSummary.List>
              <ErrorSummary.Item>
                <ErrorSummary.Link href="#month">
                  Må velge måned
                </ErrorSummary.Link>
              </ErrorSummary.Item>
              <ErrorSummary.Item>
                <ErrorSummary.Link href="#year">
                  Fra år må være et gyldig år
                </ErrorSummary.Link>
              </ErrorSummary.Item>
            </ErrorSummary.List>
          </ErrorSummary>
      ...
      <div className={cl(classes.cardWithoutBackground, classes.faqSection)}>
        ...
        <Card>
          <Details>
            ...
            <Details.Content>
              Ny husleie beregnes ut fra endringen i konsumprisindeksen fra
              tidspunktet du sist justerte husleien.
            </Details.Content>
          </Details>
          ...
          <Details>
            ...
            <Details.Content>
              Husleien kan normalt justeres én gang i året, så lenge reglene i
              husleieloven blir fulgt.
            </Details.Content>
          </Details>

          <Details>
            <Details.Summary>
              Må leietakeren varsles på forhånd?
            </Details.Summary>
            <Details.Content>
              Ja, leietakeren skal få skriftlig varsel minst én måned før ny
              husleie trer i kraft.
            </Details.Content>
          </Details>
        ...
        >
          <Card data-variant="tinted">
            ...
            <Card.Block>
              ...
              <Paragraph>
                Prisene på olje skyter i været og skaper merkbare ringvirkninger
                for både husholdninger og næringsliv.
              </Paragraph>
            </Card.Block>
          </Card>
          <Card
          ...
          >
            ...
            <Card.Block>
              ...
              <Paragraph>
                Våren er her, og hagen trenger litt stell. Godt å se at jobben
                allerede er i gang – med to dedikerte elger på skift. <br />
        ...
        <div style={{ display: "flex", gap: "1rem" }}>
          ...
          >
            ...
            <Card.Block>
              ...
              <Paragraph>
                Vi har flere tall for denne statistikken i Statistikkbanken. Lag
                figurer og tabeller med tallene du trenger.
              </Paragraph>
            </Card.Block>
          </Card>
        </div>
